//Author Morgan White SN: 101184799 COAUTHOR: Jerry Liu SN: 101073676
...
public class AreaCoverage {
  ...
  private void computeCoveragePathFrom(Node n, Edge e) {
    ...
    ArrayList<Node> nbrs = n.neighbours();
    Collections.sort(nbrs);  
    e = n.getNeighbouringEdgeTo(nbrs.get(0));
    ...
    if (e != null) {
      ...
      // Node otherNode;
      // if (e.getStartNode() == n) {
        // otherNode = e.getEndNode();
      // } else {
        // otherNode = e.getStartNode();
      // }
      // n.setPrevious(otherNode);
      n.setPrevious(e.getEndNode());    
    ...
    for (int i = 0; i < edgs.size(); i++) {
      ...
      computeCoveragePathFrom(otherNode, edgs.get(i));
    ...
    // for (int i = 0; i < nbrs.size(); i++) {
      ...
      // computeCoveragePathFrom(nbrs.get(i), n.getNeighbouringEdgeTo(nbrs.get(i)));
