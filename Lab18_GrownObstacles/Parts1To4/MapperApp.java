...
public class MapperApp extends JFrame {
  ...
  static boolean readyToTravel = false;
  ...
  // This function returns true if the user asked the robot to start traveling
  public boolean isReadyToGo() { return readyToTravel; }
  
  // This function resets the flag so that the robor can run another round
  public void resetReadyToGo() { readyToTravel = false; }
  ...
  public MapperApp(int widthInCentimeters, int heighInCentimeters) {
    ...
    JMenuItem  travelPathButton = new JMenuItem("Travel Along Path");  spMenu.add(travelPathButton); 
    ...
    travelPathButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        readyToTravel = true;
      }});
